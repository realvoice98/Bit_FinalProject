...
function GosuOverview({ gosuDetails }) {
    const { gosuName, region,gosuCategory ,gosuGender ,gosuCareer,gosuRegion,gosuAge} =
        gosuDetails;

    return (
        <Overview>
            <GosuProfileImg alt="고수이미지" src={'/images/winter6.jpg'} />
            <GosuHeadBox>
                ...
                <GosuCategory>사는지역 : {region}</GosuCategory>
