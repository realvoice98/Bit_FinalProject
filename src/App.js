...
import ModalRoot from "./pages/Modal/ModalRoot"
...
function App(props) {
    ...
    return (
        ...
        <ConnectedRouter history={history}>
            ...
            <Route path="/ModalRoot" exact component={ModalRoot}/>
            <Route path="/kakaoLogin" exact component={KakaoLogin}/>
            <Route path="/" exact component={Main}/>
            <Route path="/QuotationList" exact component={QuotationList}/>
            <Route path="/chat/sender/room" exact component={ChatApp}/>
            <Route path="/chat/sender/room/:id" exact component={ChatApp}/>
            ...
            <Route path="/quotation/:id" exact component={GosuInfoDetail}/>
            <Route exact path="/matchedgosulist/:id" component={GosuInfo} />
